    ...
    world
      ...
      .forEach(
        entity -> {
          ...
          Optional<Entity> ladder = collisionEvent.getCollisionsWith(ClimbableComponent.class).stream().findFirst();
          StateComponent oldState =
            entity.getComponent(StateComponent.class).orElseThrow();
          boolean canClimb = CollisionUtils.areAligned(entity, ladder)
