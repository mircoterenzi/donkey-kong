...
/**
 * LobbyVerticle is a Vert.x verticle that manages the game lobby for a multiplayer game.
 * It handles WebSocket connections and matchmaking logics, then starts and manages the game.
 * Finally, it manages handles disconnections, notifying the remaining player of the game over condition
 * and cleaning up the lobby for new connections.
 *
 */
public class LobbyVerticle extends AbstractVerticle {
   ...
   * then assigns roles to the connected clients (host, guest, or spectator) and manages the game state accordingly.
   *
   */
  @Override
  public void start() {
